...
<html lang="en">
  <head>
    ...
    <link href="/dashboard-user/style/main.css" rel="stylesheet" />
    @stack('addon-style')
  </head>
  ...
  <body>
    ...
    <script src="/dashboard-user/vendor/jquery/jquery.slim.min.js"></script>
    <script src="/dashboard-user/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
