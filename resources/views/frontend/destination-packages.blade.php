        ...
        <div class="container">
          <div class="row">
                  ...
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="paket-single.html">DERAWAN TRIP
                          <br />3 Hari 2 Malam</a>
                      </h2>
                    </div>
              ...
              <div class="card-box-a card-shadow">
                ...
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="paket-single.html">Wisata Sejarah
                          <br /> 1 Hari</a>
                      </h2>
                    </div>
                    <div class="card-body-a">
                      ...
                      <a href="paket-single.html" class="link-a">Lihat selengkapnya
                        <span class="bi bi-chevron-right"></span>
                      </a>
                    </div>
                    <div class="card-footer-a">
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="frontend/assets/img/property-8.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                    ...
                    <div class="card-body-a">
                      ...
                      <a href="paket-single.html" class="link-a">Click here to view
                        <span class="bi bi-chevron-right"></span>
                      </a>
                    </div>
                    <div class="card-footer-a">
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="frontend/assets/img/property-10.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
