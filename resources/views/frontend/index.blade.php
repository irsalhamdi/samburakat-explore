        ...
        <section class="section-services section-t8">
            ...
            <div class="row">
                ...
                <div class="card-box-c foo">
                    ...
                    <p class="content-c">
                        Transaksi dapat dilakukan dengan berbagai cara tanpa ada batasan tiap harinya, sehingga anda dapat
                        melakukan booking sesukanya.
                    </p>
                    </div>
                </div>
                </div>
                ...
                <div class="card-box-c foo">
                    ...
                    <div class="card-body-c">
                    <p class="content-c">
                        Anda dapat memilih jadwal sesuai dengan yang anda inginkan meskipun dilakukan jauh-jauh hari
                        sekalipun.
                    </p>
                    </div>
                </div>
        ...
        <section class="section-property section-t8">
            ...
            <div class="row">
                ...
                <div class="title-wrap d-flex justify-content-between">
                    ...
                    <a href="paket-grid.html">Semua paket
        ...
        <section class="section-news section-t8">
            ...
            <div class="row">
                ...
                <div class="title-wrap d-flex justify-content-between">
                    ...
                    <div class="title-link">
                    <a href="wisata-grid.html">Semua wisata
                        <span class="bi bi-chevron-right"></span>
                    </a>
                    </div>
                </div>
            ...
            <div id="testimonial-carousel" class="swiper">
                ...
                <div class="carousel-item-a swiper-slide">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                        <div class="testimonial-img">
                            <img src="frontend/assets/img/testimonial-2.jpg" alt="" class="img-fluid">
                        </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                        <div class="testimonial-ico">
                        ...
                        <div class="testimonial-author-box">
                            <img src="frontend/assets/img/mini-testimonial-2.jpg" alt="" class="testimonial-avatar">
